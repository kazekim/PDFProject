...
public class Options extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	public final static String PREF_MENU_ANIMATION = "menuAnimation";
	public final static String PREF_DRAW_ANIMATION = "drawAnimation";
	...
	public final static String PREF_SHOW_MENU_ON_SCROLL = "showMenuOnScroll";
	...
	public final static int MENU_BUTTONS_DISABLED = 100;
	public final static int DRAW_BUTTONS_DISABLED = 100;
	...
	private static final String[] summaryKeys = { PREF_MENU_ANIMATION, PREF_ORIENTATION, PREF_PAGE_ANIMATION,
		...
		PREF_TOP_BOTTOM_TAP_PAIR ,PREF_DRAW_ANIMATION};
	private static final int[] summaryEntryValues = { R.array.menu_animations, R.array.orientations, R.array.page_animations,
		...
		R.array.action_pairs, R.array.action_pairs, R.array.action_pairs, R.array.action_pairs, R.array.action_pairs ,R.array.draw_animations};
	private static final int[] summaryEntries = { R.array.menu_animation_labels, R.array.orientation_labels, R.array.page_animation_labels,
		...
		R.array.draw_animation_labels};
	private static final int[] summaryDefaults = { R.string.default_menu_animation, R.string.default_orientation, R.string.default_page_animation,
		...
		R.string.default_top_bottom_tap_pair,R.string.default_draw_animation };
