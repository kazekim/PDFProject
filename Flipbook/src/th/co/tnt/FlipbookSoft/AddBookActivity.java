...
import com.kazekim.function.LanguageSetting;
...
public class AddBookActivity  extends Activity implements OnItemClickListener {
	...
	private MenuItem openFileContextMenuItem = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	LanguageSetting.changeThaiLanguage(this);
    ...
    public boolean onContextItemSelected(MenuItem item) {
    	...
    	if (item == deleteContextMenuItem) {
    		...
    		setAsHome();
    	}else if(item == openFileContextMenuItem){
    		FileListEntry entry = this.fileList.get(position);
    		
    		pdfView(entry.getFile());
    	}
    	return false;
    }
    ...
    private void addBook(final File file){
    	...
    	alert.setTitle(R.string.add_book_to_bookcase);
    	alert.setMessage(file.getName());
    	...
    	public void onClick(DialogInterface dialog, int whichButton) {
    	  ...
    	  jumpToGenerateBitmapActivity(title,file);
    ...
    public void jumpToGenerateBitmapActivity(String title,File f) {
		Log.i(TAG, "post intent to open file " + f);
		Intent intent = new Intent();
		Bundle b = new Bundle();
		b.putString("filename", f.getAbsolutePath());
		b.putString("title", title);
		
		intent.setDataAndType(Uri.fromFile(f), "application/pdf");
		intent.setClass(this, GenerateBitmapActivity.class);
		intent.setAction("android.intent.action.VIEW");
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
    	...
    	if (v == this.filesListView) {
        	...
        	if (entry.getType() == FileListEntry.HOME) {
        		...
        		openFileContextMenuItem = menu.add(R.string.openfile);
        		deleteContextMenuItem = menu.add(R.string.deletefile);
        	}
    	}
    }
}