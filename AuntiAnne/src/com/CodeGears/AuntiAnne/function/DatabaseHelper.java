...
public class DatabaseHelper {
	 ...
	 private static final String DATABASE_NAME = "aunitianne.db";
	 ...
	 //  private static final String TABLE_NAME = "table1";
	   ...
	   private static class OpenHelper extends SQLiteOpenHelper {
	      ...
	      public void onCreate(SQLiteDatabase db) {
	    	  ...
	    	  db.execSQL(EcouponData.CREATETABLEQUERY);
	      }
	 
	      @Override
	      public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
	         Log.w("Example", "Upgrading database, this will drop tables and recreate.");
	         db.execSQL("DROP TABLE IF EXISTS " + EcouponData.COUPONDBTABLENAME+";");//DROP TABLE IF EXISTS " + EcouponData.MEMBERCOUPONDBTABLENAME);
	         onCreate(db);
	      }
	   }
}