...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
	...
	public BalloonOverlayView(Context context, int balloonBottomOffset) {
		...
		title.setTypeface(InitVal.Font);
		title.setTextSize(InitVal.fontSizeBalloon);
		title.setTextColor(InitVal.WHITECOLOR);
		address.setTypeface(InitVal.Font);
		address.setTextColor(InitVal.WHITECOLOR);
